    ...
    { 
        ...
        public async Task<Producto> Crear(Producto entidad, Stream imagen = null, string NombreImagen = "")
        {
            ...
            try
            {
                ...
                producto_creado =  query.Include(c => c.IdCategoriaNavigation)
                                        .Include(c => c.IdColorNavigation)
                                        .Include(c => c.IdTalleNavigation).First();
        ...
        public async Task<Producto> Editar(Producto entidad, Stream imagen = null, string NombreImagen = "")
        {
            ...
            try
            {
                ...
                Producto producto_editado = queryProducto.Include(c => c.IdCategoriaNavigation)
                                                         .Include(c => c.IdColorNavigation)
                                                         .Include(c => c.IdTalleNavigation).First();
