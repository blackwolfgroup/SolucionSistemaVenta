        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categoria>(entity =>
            {
                entity.HasKey(e => e.IdCategoria)
                    .HasName("PK__Categori__8A3D240C3AE707D5");
            ...
            modelBuilder.Entity<Color>(entity =>
            {
                entity.HasKey(e => e.IdColor)
                    .HasName("PK__Color__504A3B887C4EC4D4");
            ...
            modelBuilder.Entity<DetalleVenta>(entity =>
            {
                entity.HasKey(e => e.IdDetalleVenta)
                    .HasName("PK__DetalleV__BFE2843F894DE0AE");
            ...
            modelBuilder.Entity<Menu>(entity =>
            {
                entity.HasKey(e => e.IdMenu)
                    .HasName("PK__Menu__C26AF48321F2E461");
            ...
            modelBuilder.Entity<Negocio>(entity =>
            {
                entity.HasKey(e => e.IdNegocio)
                    .HasName("PK__Negocio__70E1E107DAB3237C");
            ...
            modelBuilder.Entity<NumeroCorrelativo>(entity =>
            {
                entity.HasKey(e => e.IdNumeroCorrelativo)
                    .HasName("PK__NumeroCo__25FB547EC79B2947");
            ...
            modelBuilder.Entity<Producto>(entity =>
            {
                entity.HasKey(e => e.IdProducto)
                    .HasName("PK__Producto__07F4A132E85D30BC");
                ...
                entity.HasOne(d => d.IdCategoriaNavigation)
                    ...
                    .HasConstraintName("FK__Producto__idCate__73BA3083");

                entity.HasOne(d => d.IdColorNavigation)
                    .WithMany(p => p.Productos)
                    .HasForeignKey(d => d.IdColor)
                    .HasConstraintName("FK__Producto__idColo__74AE54BC");

                entity.HasOne(d => d.IdTalleNavigation)
                    .WithMany(p => p.Productos)
                    .HasForeignKey(d => d.IdTalle)
                    .HasConstraintName("FK__Producto__idTall__75A278F5");
            });

            modelBuilder.Entity<Rol>(entity =>
            {
                entity.HasKey(e => e.IdRol)
                    .HasName("PK__Rol__3C872F767312F56E");
            ...
            modelBuilder.Entity<RolMenu>(entity =>
            {
                entity.HasKey(e => e.IdRolMenu)
                    .HasName("PK__RolMenu__CD2045D891E3DA35");
            ...
            modelBuilder.Entity<Talle>(entity =>
            {
                entity.HasKey(e => e.IdTalle)
                    .HasName("PK__Talle__74EEABF14CA23585");
            ...
            modelBuilder.Entity<TipoDocumentoVenta>(entity =>
            {
                entity.HasKey(e => e.IdTipoDocumentoVenta)
                    .HasName("PK__TipoDocu__A9D59AEED6CE53C0");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasKey(e => e.IdUsuario)
                    .HasName("PK__Usuario__645723A6047160EB");
            ...
            modelBuilder.Entity<Venta>(entity =>
            {
                entity.HasKey(e => e.IdVenta)
                    .HasName("PK__Venta__077D5614CCA981B6");
